...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  lcdSetup(PA0_GPIO_Port,PA8_Pin,PA9_Pin,PA0_Pin,PA1_Pin,PA2_Pin,PA3_Pin,PA4_Pin,PA5_Pin,PA6_Pin,PA7_Pin);
  /* USER CODE END 2 */
  lcdInit();
  set_cursor(1,5); lcd_send_string("A");
  set_cursor(2,5); lcd_send_string("A");
