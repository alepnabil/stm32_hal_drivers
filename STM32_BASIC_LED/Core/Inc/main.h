...
#define GPIO_PA8_Pin GPIO_PIN_8
#define GPIO_PA8_GPIO_Port GPIOA
#define LED2_CONTROL_Pin GPIO_PIN_9
#define LED2_CONTROL_GPIO_Port GPIOA
#define LED1_CONTROL_Pin GPIO_PIN_10
#define LED1_CONTROL_GPIO_Port GPIOA
